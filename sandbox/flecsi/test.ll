...
host.block:                                       ; preds = %entry
  ...
  call void @__kitsune_gpu_init_field(i32 0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @field.name, i32 0, i32 0), i8* %1, i32 4, i64 1024, i8 3)
  call void @__kitsune_gpu_set_run_size(i32 0, i64 1024, i64 0, i64 0)
