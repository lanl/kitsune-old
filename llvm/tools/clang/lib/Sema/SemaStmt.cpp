...
// This is ugly, I hate it, but it saves us re-creating all the private
// data types and functions in this file all over again...  --PM 
#include "Kitsune/SemaForAllStmt.cpp"
